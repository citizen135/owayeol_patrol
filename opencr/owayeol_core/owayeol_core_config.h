...
* See the License for the specific languacge governing permissions and
* limitations under the License.
*******************************************************************************/

/* Authors: Yoonseok Pyo, Leon Jung, Darby Lim, HanCheol Cho, Gilbert */
#ifndef OWAYEOL_CORE_CONFIG_H_
#define OWAYEOL_CORE_CONFIG_H_
...
#define WHEEL_RADIUS                     0.05           // 휠 반지름
#define BASE_LENGTH                      0.370           // 휠 축간거리


#define PWM_MAX                255            // 8 bit
#define RATE_CONTROLLER_KP          130.0         // default 150
#define RATE_CONTROLLER_KD          500.0 //4500000000000
#define RATE_CONTROLLER_KI          0.00005       //0.00001
#define RATE_INTEGRAL_FREEZE        15
#define RATE_CONTROLLER_MIN_PWM       -40             //-127?
#define RATE_CONTROLLER_MAX_PWM       40           //127?

/* Rate computing parameters */
#define RATE_DIRECTION_MEDIAN_FILTER_SIZE   3
#define RATE_CONV               0.0179   // [inc] -> [rad]
// 1ch 기준 351 (234) inc per wheel rotation
...
/* Define pins */
// motor A (right)
const byte motorRightEncoderPinA = 2;
const byte motorRightEncoderPinB = 4;
const byte enMotorRight = 10;
const byte in1MotorRight = 9;   //26 C1 M1
const byte in2MotorRight = 6;   //28 C2 M2

// motor B (left)
const byte motorLeftEncoderPinA = 3;
const byte motorLeftEncoderPinB = 5;
const byte enMotorLeft = 11;
const byte in1MotorLeft = 8;    //30
const byte in2MotorLeft = 12;    //32
