...
/* Global parameters */
#define FREQUENCY_RATE 						41 			// [ms] default 50ms
#define FREQUENCY_ODOMETRY 				    257 		// [ms] default 250ms
#define FREQUENCY_ROSPINONCE 				150 		// [ms]
#define FREQUENCY_CONTROLLER 				50 			// [ms] default 50ms
#define FREQUENCY_LASER             100

/* Rate computing parameters */
#define RATE_DIRECTION_MEDIAN_FILTER_SIZE 	3
#define RATE_CONV 							0.0047//0.0179 	// [inc] -> [rad]
...
Timer _frequency_laser(FREQUENCY_LASER);
...
const byte in1MotorRight = 26;   //26 C1 M1
const byte in2MotorRight = 28;   //28 C2 M2

// motor B (left)
const byte motorLeftEncoderPinA = 7;
const byte motorLeftEncoderPinB = 3;
const byte enMotorLeft = 11;
const byte in1MotorLeft = 30;    //30
const byte in2MotorLeft = 32;    //32
